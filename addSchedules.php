...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Lion's Den Gym | Add Schedules</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Add Schedules</h4>
                                </div>
                                ...
                                <form class="form-horizontal" name="form" method="post" action="" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="mname" id="mname" placeholder="Enter Member Name" onkeyup="checkMname()" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="Exname" id="Exname" placeholder="Enter Exercise Name" onkeyup="checkExname()" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="sets" id="sets" placeholder="Enter Sets" onkeyup="checkSet()" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="reps" id="reps" placeholder="Enter Reps" onkeyup="checkRep()" required>
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group m-b-sm">
                                                            ...
                                                            <input type="text" class="form-control"  name="rtime" id="rtime" placeholder="Enter Rest Time" onkeyup="checkRTime()" required>
                                        ...
                                        <div class="col-sm-6" style="margin-left:40%;">
                                                    ...
                                                    <div class="col-md-3">
                                                    <button type="submit" name="addSch" id="addSch" class="btn btn-primary btn-rounded">Add</button>
                                                    </div>
...
<script>
    ...
    <script>
            const submit = document.querySelector('#addSch');
            function isValid(){
            ...
            function returnToPrevious (e) {
                ...
                if(!isValid()) {
                    ...
                    if(e.preventDefault) {
                        e.preventDefault();
                        alert("Schedule didn't Add. Please enter valid inputs.");
                    } else {
                        e.returnValue = false;
                    }
                }
    ...
    <?php
        ...
        $addSch = "INSERT INTO `schedule` ( `mname`,  `Exname`, `sets`, `reps` , `date` , `rtime`) 
                            VALUES ('$mname','$Exname','$sets','$reps' ,'$date' ,'$rtime')";

            
            $run_staff = mysqli_query($conn, $addSch );

        if ($run_staff) {
                echo "<script> alert('Schedule Added successfully ')</script>";
                echo "<script> window.open('addSchedules.php')</script>"; 
            }
            else{
                echo "<script> alert('Schedule Didnt Added  ')</script>";
