...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Lion's Den Gym | Supplement Payment</title>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Supplement Payment</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Supplement Payment</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                            <label for="ename" class="col-sm-2 control-label">Member's Name</label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Supplement Name</label>
                                            <div class="col-sm-3">
                                                <select class="form-control m-b-sm">
                                                    <!-- <option>Monthly</option>
                                                    <option>Annuly</option>
                                                    <option>Premium</option> -->
                                                    <?php
           
                                                  

                                                        $get_pro = "select supname  from supliment";
                                                ...
                                                while ($row_pro = mysqli_fetch_array($run_pro)) {
                                                            ...
                                                            extract($row_pro);
                                                            // echo "<option value=''>$row_pro</option>\n";
                                                            echo "<option value=''>$supname</option>\n"; 
                                                        }
