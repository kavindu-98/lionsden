...
if(isset($_GET['editEq'])){

$edit_id = $_GET['editEq'];

$get_pro = "select * from equipment where id='$edit_id'";
...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Lion's Den Gym | Edit Equipments</title>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Update Equipments Form</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Update Equipments</h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="ename" id="ename" placeholder="Enter Equipment Name" onkeyup="checkEqName()" value="<?php echo $ename?>" required >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="amount" id="amount" placeholder="Enter Amount" onkeyup="checkAmount()" value="<?php echo $amount?>" required >
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-2">
                                                <input type="date" name="date" id="date" class="form-control " onkeyup="checkRegDate()" value="<?php echo $date?>" required >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="description" id="description" placeholder="Enter Description" onkeyup="checkDescription()" value="<?php echo $description?>" required >
                                        ...
                                        <div class="col-sm-6" style="margin-left:40%;">
                                                    ...
                                                    <div class="col-md-3">
                                                    <button type="submit" name="updateEq" id="updateEq" class="btn btn-primary btn-rounded">Update</button>
                                                    </div>
...
<script>
    ...
    <script>
            const submit = document.querySelector('#updateEq');
            function isValid(){
            ...
            function returnToPrevious (e) {
                ...
                if(!isValid()) {
                    ...
                    if(e.preventDefault) {
                        e.preventDefault();
                        alert("Equipment didn't updated. Please enter valid inputs.");
                    } else {
                        e.returnValue = false;
                    }
                }
    ...
    <?php
        ...
        $editEq = "update equipment  set ename='$ename',amount='$amount',date='$date',description='$description' where id= '$edit_id'";
                           

            
            $run_staff = mysqli_query($conn,  $editEq );

        if ($run_staff) {
                echo "<script> alert('ITEM Updated successfully ')</script>";
                echo "<script> window.open('viewEquipment.php')</script>"; 
            }
            else{
                echo "<script> alert('Item Didnt Updated  ')</script>";
