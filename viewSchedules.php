...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Lion's Den Gym | View Equipments</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">View Schedules</h4>
                                </div>
                                   ...
                                   <div class="table-responsive">
                                        ...
                                        <tbody>
                                                       ...
                                                       <tr>
                                                                   ...
                                                                   <td>
                                                                        <a href="EditSchedules.php?editSch=<?php echo $id; ?>">
                                                                          <i class="fa fa-pencil"> </i> Edit
                                                                          </a>
                                                                    </td>
                                                                    <td>
                                                                       <a href="deleteSuppliment.php?deletesup=<?php echo $id; ?>">
