...
<html>
    <head>
        ...
        <!-- Title -->
        <title>Lion's Den Gym | Coach Summary</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Coach Details</h4>
                                </div>
                                <div class="panel-body">
                                   <div class="table-responsive">
                                        ...
                                        <tbody>
                                             ...
                                             <?php
                                                   ...
                                                   $get_pro = "select *  from coach_rej";
                                                    ...
                                                    $nic = $row_pro['nic'];
                                                    $qualification = $row_pro['qualification'];
                                        ...
                                        <a href="EditCoach.php?editCoach=<?php echo $id; ?>">
                                       ...
                                       <a href="deleteCoach.php?deleteCoach=<?php echo $id; ?>">
