                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                            <label for="ename" class="col-sm-2 control-label">Coach's Name</label>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="ename" id="ename" placeholder="Enter Coach's Name" onkeyup="checkEqName()" required >
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h3>Thank you !</h3>
                                            <p>Nullam quis ascetur ridiculus mus. Donec ullamcorper nulla non metus auctor fringilla.</p>
